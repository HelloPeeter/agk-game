...
//--Carregando BackGround e Floor--//
	...
	LoadImage(floor1_img, 'background/chao_1.png') 
	LoadImage(floor2_img, 'background/chao_2.png')
	LoadImage(floor3_img, 'background/chao_3.png')
	...
	//Loading Images
	LoadImage(lamp_img,'background/lamp.png') //23x57
	loadImage(lampcopy_img, 'background/lamp.png') //23x57
	LoadImage(grass1_img, 'background/grass_2.png') //10x5
	LoadImage(fence1_img, 'background/fence_1.png') //73x19
	LoadImage(fence2_img, 'background/fence_2.png') //73x19
	LoadImage(sign_img, 'background/sign.png') //22x31
